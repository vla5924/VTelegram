    ...
    static public function make(array $entries, string $messageTemplate = null, string $parseMode = null, bool $disableWebPagePreview = false): array
    {
        ...
        foreach ($entries as $entry) {
            ...
            if ($messageTemplate) {
                ...
                $result[] = new Photo($entry[self::ID], $entry[self::PHOTO_URL], $entry[self::THUMB_URL], $extraParameters, $inputMessageContent);
            } else {
                $result[] = new Photo($entry[self::ID], $entry[self::PHOTO_URL], $entry[self::THUMB_URL], $extraParameters);
            }
        }
        return $result;
    }
