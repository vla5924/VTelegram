...
trait CallbackQueryHandlers
{
    ...
    /**
     * @memberof CallbackQueryHandlers
     ...
     * So you can use it like this:
     * @code
     * VTgBot::registerDynamicCallbackQueryHandler('get_%d', function (VTg\BotController $bot, VTg\Objects\CallbackQuery $callbackQuery, array $parameters) {
     ...
     * @param callable $handler Dynamic callback query handler [function (BotController, CallbackQuery, array)]
     */
